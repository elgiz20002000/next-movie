  ...
  return (
    <div className={styles.navbar}>
        ...
        <div className={styles.input_wrapper}>
            <input onKeyDown={SearchHandle} onInput={(e) => setSearch(e.currentTarget.value)} type="text" value={search}/>
        </div>
        {status == 'authenticated' ?  <div className={styles.current_user}>User: {session.user?.name}</div> :
            <>
